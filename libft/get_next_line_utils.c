...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/05 18:30:49 by yubin             #+#    #+#             */
/*   Updated: 2024/01/05 18:58:46 by yubin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_parse_rcd(t_list **fdlst_ptr, char **res_ptr, int reslen)
{
	...
	rcdlen = ft_strchr_gnl((*fdlst_ptr)->record, '\0') - reslen;
...
int	ft_strdup_gnl(t_list **rcdlst_ptr, t_list **fdlst_ptr, char **res_ptr)
{
	...
	ft_strchr_gnl((*fdlst_ptr)->record, '\0'))
		return (0);
	reslen = ft_strchr_gnl((*fdlst_ptr)->record, '\0');
	if (reslen == -1)
		reslen = ft_strchr_gnl((*fdlst_ptr)->record, '\0');
